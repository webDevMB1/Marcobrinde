...
<head>
	...
	<title>ADMIN - Adicionar Banner</title>
</head>
<body>
...
<div id="teste"></div>
	...
	<div id="descricaoSeccao" class="row">
		<center>
			...
			<br>
			<p>Esta area adiciona um novo banner no carousel da página inicial da página.</p>
			<p>A informação introduzida aqui é alterar o carousel que é apresentado na primeira página da loja.</p>
		</center>
	</div>
	...
	<div id="explicacao" class="row">
		...
		<br>
		<p>Esta área efectua alterações a nível de layout da página e pastas dos banners. Ao adicionar um novo banner está a ser adicionada uma nova entrada à lista de banners que estão a ser apresentados e as imagens (normal e para fundos escuros) estão a ser adicionadas à pasta. </p>
	</div>

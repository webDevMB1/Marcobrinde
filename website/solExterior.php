...
<html>
<head>
<title>MarcoBrinde - Soluções de Exterior</title>
		...
		<div class="row info-part">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 info-specs" style="margin-left: 2%; margin-right: -2%">
				<div class="text-center info-details slideanim">
					<p style="color: white">Temos para lhe oferecer uma ampla gama de soluções de exterior que o ajudarão na divulgação da sua empresa.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="experience-top-grids">
			<div class="row">
				...
				<div class="col-md-3 experience-grid">
					<div class="experience-grid-icon icon-left">
						<a href="solExterior.php"><img class="imgExterior" src="images/gallery-img1.jpg" style="font-size: 20px; width: 70%; height: auto" alt="Reclamos"></a>
					</div>
				...
				<div class="col-md-3 experience-grid experience-grid1" style="border-right: none !important">
					<div class="experience-grid-icon icon-left">
						<a href="solExterior.php"><img class="imgExterior" src="images/gallery-img2.jpg" style="font-size: 20px; width: 70%; height: auto" alt="Reclamos"></a>
					</div>
					<div class="experience-grid-info">
						<h5 style="color: white">----------</h5>
						<p>Curabitur augue urna, venenatis vel enim at, sodales tempus diam. Aliquam ornare, magna a cursus tempus, arcu massa accumsan justo, non facilisis risus ante vel ex.</p>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Muppys</h4>
        </div>
...
<script>
	...
	$(document).ready(function(){
		...
		$('.hover').on(event, function(){

			$('.hover').find('p').css('visibility','hidden');

			if( $(this).find('p').attr('visible') == 'false' ){
				$(this).find('p').attr('visible', 'true');
				$(this).find('p').css('visibility', 'visible');
			}else{
				$(this).find('p').attr('visible', 'false');
				$(this).find('p').css('visibility', 'hidden');
			}
			
		});

		$("#faContact").attr("href","../website");

		$("#row1").css("margin", "0px");
		$("#row2").css("margin-top", "15px");
		$("#row2").css("margin-right", "0px");

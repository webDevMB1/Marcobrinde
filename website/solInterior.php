...
<html>
<head>
<title>MarcoBrinde - Soluções de Interior</title>
...
<section class="our-info" id="top" style="margin-top: 10%">
	<div class="container">
		<div class="row info-part">
			<h3 class="text-center slideanim" style="color: white">Soluções de Interior</h3>
			<div class="col-lg-12 col-md-12 col-sm-12 info-specs" style="margin-left: 2%; margin-right: -2%">
				<div class="text-center info-details slideanim">
					<p style="color: white">Temos para lhe oferecer uma ampla gama de soluções de interior.</p>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-3 experience-grid hover">
					<div class="wrapper experience-grid-icon icon-left">
						...
						<a href="solExterior.php">
							<p class="text" style="margin-left: -2%">
					...
					<div class="experience-grid-info">
						<h5 style="color: white">Runny / Rolo</h5>
					</div>
				</div>
				<div class="col-md-3 experience-grid experience-grid1 hover">
					<div class="wrapper experience-grid-icon icon-left">
						...
						<a href="solExterior.php">
							<p>
							<p class="text" style="margin-left: -7%">
					...
					<div class="experience-grid-info">
						<h5 style="color: white">Vertical</h5>
					</div>
				</div>
				<div class="col-md-3 experience-grid experience-grid2 hover">
					...
					<div class="experience-grid-info">
						<h5 style="color: white">Horizontal</h5>
					</div>
				</div>
